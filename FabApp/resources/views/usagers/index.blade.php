                        ...
                        <table class="w-100">
                            ...
                            @foreach ($usagers as $usager)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('usagers.supprimer', $usager->id) }}" method="POST">
                                            @csrf 
                                            <button type="submit" name="suppUser" id="suppUser"  class="bg-deco"><i class="fa-solid fa-xmark hoverSupp"></i></button>
                                        </form> 
                                    </td>
                                    <td>
                                        <form action="{{ route('usagers.edit', $usager->adresseCourriel) }}" method="POST">
                                            @csrf 
